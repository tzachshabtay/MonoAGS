...
namespace Tests
{
    ...
    public class TextBoxComponentTests
    {
        ...
        {                                    
            ...
            Mock<IInObjectTreeComponent> inTree = new Mock<IInObjectTreeComponent>();
            ...
            entity.Setup(e => e.GetComponent<IInObjectTreeComponent>()).Returns(inTree.Object);
			...
			entity.Setup(e => e.Bind(It.IsAny<Action<IInObjectTreeComponent>>(), It.IsAny<Action<IInObjectTreeComponent>>()))
				  .Callback<Action<IInObjectTreeComponent>, Action<IInObjectTreeComponent>>((addComponent, _) => addComponent(inTree.Object));
            ...
            gameEvents.Setup(g => g.OnRepeatedlyExecute).Returns(new Mock<IBlockingEvent<IRepeatedlyExecuteEventArgs>>().Object);
